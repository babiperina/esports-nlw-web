...
function App() {
  return (
    <div className='max-w-[1344px] mx-auto flex flex-col items-center my-20'>
      <img src={logo} alt="logo-nlw-esports.svg" />
      ...
      <div className='grid grid-cols-6 gap-6 mt-16'>
        <a href="" className="relative rounded-lg overflow-hidden">
          ...
          <div className='w-full pt-16 pb-4 px-4 bg-game-box-gradient absolute bottom-0 left-0 right-0'>
      ...
      <div className='pt-1 bg-nlw-gradient rounded-lg self-stretch mt-8 overflow-hidden'>
        <div className='bg-[#2A2634] px-8 py-6 flex justify-between items-center'>
          ...
          <button className='bg-violet-500 rounded-md text-base py-3 px-4 text-white hover:bg-violet-700 flex items-center gap-3'>
